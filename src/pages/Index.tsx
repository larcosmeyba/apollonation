        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center gap-3 mb-4">
              <a href="#" className="plausible-event-name=App+Store+Click flex items-center gap-2.5 bg-white text-black px-5 py-3 rounded-xl hover:bg-white/90 transition-all hover:-translate-y-0.5">
              ...
              <a href="#" className="plausible-event-name=Google+Play+Click flex items-center gap-2.5 bg-white text-black px-5 py-3 rounded-xl hover:bg-white/90 transition-all hover:-translate-y-0.5">
                <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
