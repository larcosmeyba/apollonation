      ...
      <div className="container mx-auto px-4 py-16 max-w-5xl">
        {isInactiveAccount && (
          <div className="mb-10 border border-primary/30 bg-primary/[0.05] p-6 text-center">
            ...
            <p className="text-muted-foreground text-sm font-light max-w-md mx-auto">
              We've missed you! Pick up where you left off by selecting a plan below.
            </p>
          </div>
        )}
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-base font-light max-w-md mx-auto">
            {isInactiveAccount
              ? "Choose a plan to regain access to your training dashboard."
            ...
            return (
              ...
              >
                ...
                <div className="text-center mb-10 pt-4">
                  ...
                  <p className="text-muted-foreground text-xs font-light mb-6">{feat.description}</p>
                  <div className="flex items-baseline justify-center gap-1">
                    <span className="text-muted-foreground text-lg font-light">$</span>
                    <span className={`font-heading text-4xl tracking-wide ${featured ? "text-primary" : "text-foreground"}`}>
                      {tier.price}
                    </span>
