          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
                  ...
                  <>
                    ...
                    <Link to="/auth">
                      <Button
                        variant="outline"
                        size="lg"
                        className="min-w-[200px] h-14 text-base border-primary/30 text-primary hover:bg-primary/10 rounded-full"
                      >
                        Create Account
                      </Button>
                    </Link>
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={item.title}
                  className="flex items-start gap-4 p-5 border border-primary/10 hover:border-primary/30 bg-card/30 transition-all duration-500 rounded-2xl"
                >
                  <div className="w-10 h-10 flex items-center justify-center border border-primary/30 shrink-0 rounded-full">
                    <item.icon className="w-4 h-4 text-primary" strokeWidth={1.5} />
                  </div>
                  <div>
                    <h4 className="font-heading text-sm tracking-[0.08em] text-foreground mb-1">
                      {item.title}
                    </h4>
