    ...
    <header className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 w-full" role="banner">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div 
            className={`inline-flex items-center gap-2 px-5 py-2 border border-gray-900/20 bg-gray-900/5 backdrop-blur-sm mb-8 rounded-full transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
          >
            <span className="w-1.5 h-1.5 rounded-full bg-gray-900 animate-pulse flex-shrink-0" />
            <span className="text-[10px] text-gray-900 font-medium tracking-[0.2em] uppercase">
          ...
          >
            <span className="block text-gray-900">Forge Your</span>
            <span className="block text-gray-600 mt-2">Legend</span>
          </h1>

          <p 
            className={`text-lg md:text-xl text-gray-600 max-w-xl mx-auto mb-12 font-light leading-relaxed transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
          ...
          >
            ...
            <a href="#features">
              <Button variant="apollo-outline" size="lg" className="min-w-[200px] h-14 text-base rounded-full border-gray-900/30 text-gray-900 hover:bg-gray-900/5">
                Explore Coaching
              </Button>
            </a>
          </div>
          ...
          <div 
            className={`grid grid-cols-3 gap-6 mt-16 pt-8 border-t border-gray-900/15 max-w-lg mx-auto transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
            {[
              ...
              <div key={stat.value}>
                <div className="font-heading text-lg md:text-xl text-gray-900 mb-1 tracking-wide">
                  {stat.value}
                </div>
