    ...
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {/* Featured Video */}
          <div className="md:col-span-2 lg:row-span-2 group relative overflow-hidden cursor-pointer border border-primary/10 hover:border-primary/40 transition-all duration-500 rounded-2xl">
            <img
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-20 h-20 border-2 border-primary bg-primary/10 backdrop-blur-sm flex items-center justify-center transform group-hover:scale-110 group-hover:bg-primary/20 transition-all duration-300 rounded-full">
                <Play className="w-8 h-8 text-primary fill-current ml-1" />
              </div>
            </div>

            <div className="absolute bottom-0 left-0 right-0 p-6">
              <span className="inline-block px-4 py-1.5 bg-primary text-primary-foreground text-[10px] font-medium uppercase tracking-[0.2em] mb-4 rounded-full">
                Featured
              </span>
          ...
          {videos.slice(1).map((video, index) => (
            <div
              key={index}
              className="group relative overflow-hidden cursor-pointer border border-primary/10 hover:border-primary/40 transition-all duration-500 rounded-2xl"
            >
              <img
                src={video.thumbnail}
                alt={video.title}
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="w-14 h-14 border-2 border-primary bg-primary/10 backdrop-blur-sm flex items-center justify-center rounded-full">
