      ...
      <div className="container mx-auto px-4 py-14">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-5">
            <a href="https://www.instagram.com/apollorebornapp" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/70 transition-colors" aria-label="Instagram">
            ...
            <a href="https://www.tiktok.com/@larcosfit" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/70 transition-colors" aria-label="TikTok">
        ...
        <div className="mt-6 text-center">
          <a
            href="mailto:support@apolloreborn.com"
