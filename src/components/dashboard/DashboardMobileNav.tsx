            ...
            <div className="flex flex-col h-full">
              ...
              <div className="px-6 py-6 border-t border-border">
                ...
                <div className="flex items-center gap-4">
                  <a href="https://instagram.com/apollorebornapp" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-foreground/10 border border-border flex items-center justify-center hover:bg-foreground/20 transition-colors">
                  ...
                  <a href="https://tiktok.com/@larcosfit" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-foreground/10 border border-border flex items-center justify-center hover:bg-foreground/20 transition-colors">
