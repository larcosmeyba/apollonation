...
import { Menu, Search, Bookmark, X } from "lucide-react";
          ...
          <SheetContent side="left" className="w-72 bg-card border-border p-0">
            <div className="flex flex-col h-full">
              ...
              <div className="px-6 pt-8 pb-6 border-b border-border">
                <h2 className="font-heading text-xl text-foreground">Apollo Nation</h2>
              </div>
              ...
              <div className="px-6 py-6 border-t border-border">
                <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground mb-4">Follow Us</p>
                <div className="flex items-center gap-4">
                  <a href="https://instagram.com/apollonation" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-foreground/5 border border-border flex items-center justify-center hover:bg-foreground/10 transition-colors">
                  ...
                  <a href="https://tiktok.com/@apollonation" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-foreground/5 border border-border flex items-center justify-center hover:bg-foreground/10 transition-colors">
                  ...
                  <a href="https://youtube.com/@apollonation" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-foreground/5 border border-border flex items-center justify-center hover:bg-foreground/10 transition-colors">
